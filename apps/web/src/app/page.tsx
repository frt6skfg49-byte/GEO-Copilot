  ...
  return (
    <div className="flex flex-col items-center px-6 py-16">
      ...
      <div className="mb-12 text-center animate-slide-up">
        <div className="mx-auto mb-5 flex size-14 items-center justify-center rounded-2xl bg-primary/8 ring-1 ring-primary/15">
        ...
        <Card className="border-border bg-card backdrop-blur-sm">
          <CardContent className="pt-6 space-y-4">
            ...
            >
              {isSubmitting ? (
                <>
                  <span className="mr-2 size-4 animate-spin rounded-full border-2 border-primary/20 border-t-primary" />
                  正在创建分析...
                </>
              ) : (
                <>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className="w-full rounded-md border border-border bg-background px-3 py-2 text-sm text-foreground outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/15"
                    >
      ...
      <div className="mt-12 w-full max-w-2xl animate-fade-in">
        ...
        <div className="space-y-2">
          {RECENT_URLS.map((item) => (
            <Card
              key={item.url}
              className="group cursor-pointer border-border bg-secondary/50 hover:bg-secondary transition-all"
              onClick={() =>
                router.push(
